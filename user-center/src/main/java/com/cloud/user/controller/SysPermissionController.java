...
public class SysPermissionController {
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "sysPermission",value = "用户权限",dataTypeClass = SysPermission.class),
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "id",value = "权限id",paramType = "path",dataTypeClass = Long.class),
			@ApiImplicitParam(name = "access_token",value = "token",required = true)
	})
	...
	@ApiImplicitParams({
			@ApiImplicitParam(name = "params",value = "权限参数,包含permission,权限标示；name,权限名称",paramType = "query",dataTypeClass = Map.class),
			@ApiImplicitParam(name = "access_token",value = "token",required = true)
	})
