...
function initMenu(){
    var access_token = localStorage.getItem("access_token");
	 $.ajax({  
	     url: domainName + "/menus/me?access_token=" + access_token,
	     type:"get",  
	     async:false,
...
function showLoginInfo(){
	...
	$.ajax({
		type : 'get',
		url : 'http://8.210.80.161:8001/users/current?access_token=' + access_token,
		async : false,
		success : function(data) {
...
function logout(){
	...
	$.ajax({
		type : 'get',
		url : 'http://8.210.80.161:8001/sys/logout?access_token=' + access_token,
		success : function(data) {
