 ...
 * under the License.
 */
package com.cloud.notification.tuna.netty.handler.codec.http;
...
import com.cloud.notification.tuna.netty.channel.embedded.EmbeddedChannel;
import com.cloud.notification.tuna.netty.handler.codec.MessageToMessageCodec;
...
public abstract class HttpContentEncoder extends MessageToMessageCodec<HttpRequest, HttpObject> {
    ...
    protected void decode(ChannelHandlerContext ctx, HttpRequest msg, List<Object> out)
            throws Exception {
        String acceptedEncoding = msg.headers().get(Names.ACCEPT_ENCODING);
