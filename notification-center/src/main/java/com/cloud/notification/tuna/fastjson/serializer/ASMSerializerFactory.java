...
import com.cloud.notification.tuna.fastjson.JSON;
import com.cloud.notification.tuna.fastjson.JSONException;
import com.cloud.notification.tuna.fastjson.annotation.JSONField;
import com.cloud.notification.tuna.fastjson.annotation.JSONType;
import com.cloud.notification.tuna.fastjson.asm.*;
import com.cloud.notification.tuna.fastjson.util.ASMClassLoader;
import com.cloud.notification.tuna.fastjson.util.ASMUtils;
...
import static com.cloud.notification.tuna.fastjson.util.ASMUtils.getDesc;
import static com.cloud.notification.tuna.fastjson.util.ASMUtils.getType;
...
public class ASMSerializerFactory implements Opcodes {
    ...
    public ObjectSerializer createJavaBeanSerializer(Class<?> clazz, Map<String, String> aliasMap) throws Exception {
        ...
        cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, className, "com/alibaba/tuna/fastjson/serializer/ASMJavaBeanSerializer",
                 new String[] { "com/alibaba/tuna/fastjson/serializer/ObjectSerializer" });
        ...
        mw.visitLdcInsn(com.cloud.notification.tuna.fastjson.asm.Type.getType(getDesc(clazz)));
        mw.visitMethodInsn(INVOKESPECIAL, "com/alibaba/tuna/fastjson/serializer/ASMJavaBeanSerializer", "<init>", "(Ljava/lang/Class;)V");
        ...
        for (FieldInfo fieldInfo : getters) {
            ...
            mw.visitLdcInsn(com.cloud.notification.tuna.fastjson.asm.Type.getType(getDesc(fieldInfo.getDeclaringClass())));

            if (fieldInfo.getMethod() != null) {
                mw.visitLdcInsn(fieldInfo.getMethod().getName());
                mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/util/ASMUtils", "getMethodType",
                                   "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Type;");

            } else {
                mw.visitLdcInsn(fieldInfo.getField().getName());
                mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/util/ASMUtils", "getFieldType",
                                   "(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Type;");
            }
...

        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "write",
                                "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V",
                                null, new String[] { "java/io/IOException" });

            mw.visitVarInsn(ALOAD, context.serializer()); // serializer
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "getWriter",
                               "()Lcom/alibaba/tuna/fastjson/serializer/SerializeWriter;");
            ...
            if (jsonType == null || jsonType.alphabetic()) {
                ...
                mw.visitFieldInsn(GETSTATIC, "com/alibaba/tuna/fastjson/serializer/SerializerFeature", "SortField",
                                  "Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "isEnabled",
                                   "(Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;)Z");
        ...
        // writeAsArray
        {
            ...
            mw = cw.visitMethod(ACC_PUBLIC,
                                "writeAsArray",
                                "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;)V",
                                null, new String[] { "java/io/IOException" });
    ...
    private void generateWriteAsArray(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "write", "(C)V");
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (propertyClass == byte.class //
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeIntAndChar", "(IC)V");

            } else if (propertyClass == long.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeLongAndChar", "(JC)V");

            } else if (propertyClass == float.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFloatAndChar", "(FC)V");

            } else if (propertyClass == double.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeDoubleAndChar", "(DC)V");

            } else if (propertyClass == boolean.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeBooleanAndChar", "(ZC)V");
            } else if (propertyClass == char.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeCharacterAndChar", "(CC)V");

            } else if (propertyClass == String.class) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeString",
                                   "(Ljava/lang/String;C)V");
            } else if (propertyClass.isEnum()) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                _get(mw, context, property);
                mw.visitVarInsn(BIPUSH, seperator);
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeEnum", "(Ljava/lang/Enum;C)V");
            } else {
                ...
                if (format != null) {
                    ...
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "writeWithFormat",
                                       "(Ljava/lang/Object;Ljava/lang/String;)V");
                } else {
                    mw.visitVarInsn(ALOAD, context.fieldName());
                    if (property.getFieldType() instanceof Class<?> //
                        && ((Class<?>) property.getFieldType()).isPrimitive()) {
                        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "writeWithFieldName",
    ...
    private void generateWriteMethod(Class<?> clazz, MethodVisitor mw, List<FieldInfo> getters, Context context)
...

        {
            ...
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitFieldInsn(GETSTATIC, "com/alibaba/tuna/fastjson/serializer/SerializerFeature", "PrettyFormat",
                              "Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;");
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "isEnabled",
                               "(Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;)Z");
            ...
            mw.visitVarInsn(ALOAD, 0);
            mw.visitFieldInsn(GETFIELD, context.getClassName(), "nature", "Lcom/alibaba/tuna/fastjson/serializer/JavaBeanSerializer;");
            ...
            mw.visitVarInsn(ALOAD, 4);
            mw.visitVarInsn(ILOAD, 5);
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JavaBeanSerializer", "write",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
            mw.visitInsn(RETURN);
...

        {
            ...
            mw.visitVarInsn(ALOAD, 2);
            mw.visitVarInsn(ILOAD, 5);
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JavaBeanSerializer", "writeReference",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;I)Z");
...

        {
            ...
            mw.visitFieldInsn(GETFIELD, context.getClassName(), "nature", "Lcom/alibaba/tuna/fastjson/serializer/JavaBeanSerializer;");
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JavaBeanSerializer", "isWriteAsArray",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;)Z");
        ...
        {
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "getContext",
                               "()Lcom/alibaba/tuna/fastjson/serializer/SerialContext;");
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "setContext",
                               "(Lcom/alibaba/tuna/fastjson/serializer/SerialContext;Ljava/lang/Object;Ljava/lang/Object;I)V");
        }
        ...
        // SEPERATO
        {
            ...
            // mw.visitVarInsn(ALOAD, context.var("out"));
            // mw.visitFieldInsn(GETSTATIC, "com/alibaba/tuna/fastjson/serializer/SerializerFeature", "WriteClassName",
            // "L" + "com/alibaba/tuna/fastjson/serializer/SerializerFeature" + ";");
            // mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "isEnabled",
            // "(" + "L" + "com/alibaba/tuna/fastjson/serializer/SerializerFeature" + ";" + ")Z");
            // mw.visitJumpInsn(IFEQ, else_);

            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitVarInsn(ALOAD, context.paramFieldType());
            mw.visitVarInsn(ALOAD, context.obj());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "isWriteClassName",
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "write", "(Ljava/lang/String;)V");
            mw.visitVarInsn(BIPUSH, ',');
        ...
        mw.visitVarInsn(ALOAD, context.var("parent"));
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "setContext",
                           "(Lcom/alibaba/tuna/fastjson/serializer/SerialContext;)V");
    ...
    private void _enum(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (writeEnumUsingToString) {
            ...
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue",
    ...
    private void _long(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;J)V");
    ...
    private void _float(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;F)V");
    ...
    private void _double(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;D)V");
    ...
    private void _char(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;C)V");
    ...
    private void _boolean(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;Z)V");
    ...
    private void _byte(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldValue", "(CLjava/lang/String;I)V");
    ...
    private void _list(Class<?> clazz, MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.var("out"));
        mw.visitVarInsn(ALOAD, context.fieldName());
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldName", "(Ljava/lang/String;)V");
...

        {
            ...
            mw.visitTypeInsn(CHECKCAST, "com/alibaba/tuna/fastjson/serializer/ObjectSerializer"); // cast to string
            ...
            if (elementType == String.class) {
                ...
                if (elementClass != null && Modifier.isPublic(elementClass.getModifiers())) {
                    mw.visitLdcInsn(com.cloud.notification.tuna.fastjson.asm.Type.getType(getDesc((Class<?>) elementType)));
                    mw.visitLdcInsn(property.getSerialzeFeatures());
                    mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "writeWithFieldName",
                                       "(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/reflect/Type;I)V");
                } else {
        ...
        {
            mw.visitVarInsn(ALOAD, context.serializer());
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/JSONSerializer", "popContext", "()V");
        }
    ...
    private void _filters(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        if (property.getField() != null) {
            if (Modifier.isTransient(property.getField().getModifiers())) {
                mw.visitVarInsn(ALOAD, context.var("out"));
                mw.visitFieldInsn(GETSTATIC, "com/alibaba/tuna/fastjson/serializer/SerializerFeature", "SkipTransientField",
                                  "Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;");
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "isEnabled",
                                   "(Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;)Z");
    ...
    private void _nameApply(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ALOAD, context.fieldName());
        mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "applyName",
                           "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;)Z");
        mw.visitJumpInsn(IFEQ, _end);
    }
    ...
    private void _before(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ILOAD, context.var("seperator"));
        mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "writeBefore",
                           "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _after(MethodVisitor mw, Context context) {
        ...
        mw.visitVarInsn(ALOAD, context.obj());
        mw.visitVarInsn(ILOAD, context.var("seperator"));
        mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "writeAfter",
                           "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;C)C");
        mw.visitVarInsn(ISTORE, context.var("seperator"));
    }
    ...
    private void _notWriteDefault(MethodVisitor mw, FieldInfo property, Context context, Label _end) {
        ...
        mw.visitVarInsn(ALOAD, context.var("out"));
        mw.visitFieldInsn(GETSTATIC, "com/alibaba/tuna/fastjson/serializer/SerializerFeature", "NotWriteDefaultValue",
                          "Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;");
        mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "isEnabled",
                           "(Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;)Z");
    ...
    private void _apply(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Z");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Z");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Z");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Z");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Z");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Z");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Z");
            ...
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "apply",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Z");
    ...
    private void _processValue(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        mw.visitMethodInsn(INVOKESTATIC,
                           "com/alibaba/tuna/fastjson/serializer/FilterUtils",
                           "processValue",
                           "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;");
    ...
    private void _processKey(MethodVisitor mw, FieldInfo property, Context context) {
        ...
        if (propertyClass == byte.class) {
            mw.visitVarInsn(ILOAD, context.var("byte"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;B)Ljava/lang/String;");
        } else if (propertyClass == short.class) {
            mw.visitVarInsn(ILOAD, context.var("short"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;S)Ljava/lang/String;");
        } else if (propertyClass == int.class) {
            mw.visitVarInsn(ILOAD, context.var("int"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;I)Ljava/lang/String;");
        } else if (propertyClass == char.class) {
            mw.visitVarInsn(ILOAD, context.var("char"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;C)Ljava/lang/String;");
        } else if (propertyClass == long.class) {
            mw.visitVarInsn(LLOAD, context.var("long", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;J)Ljava/lang/String;");
        } else if (propertyClass == float.class) {
            mw.visitVarInsn(FLOAD, context.var("float"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;F)Ljava/lang/String;");
        } else if (propertyClass == double.class) {
            mw.visitVarInsn(DLOAD, context.var("double", 2));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;D)Ljava/lang/String;");
        } else if (propertyClass == boolean.class) {
            mw.visitVarInsn(ILOAD, context.var("boolean"));
            mw.visitMethodInsn(INVOKESTATIC, "com/alibaba/tuna/fastjson/serializer/FilterUtils", "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Z)Ljava/lang/String;");
        } else if (propertyClass == BigDecimal.class) {
            mw.visitVarInsn(ALOAD, context.var("decimal"));
            mw.visitMethodInsn(INVOKESTATIC,
                               "com/alibaba/tuna/fastjson/serializer/FilterUtils",
                               "processKey",
                               "(Lcom/alibaba/tuna/fastjson/serializer/JSONSerializer;Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;");
        } else if (propertyClass == String.class) {
            mw.visitVarInsn(ALOAD, context.var("string"));
            mw.visitMethodInsn(INVOKESTATIC,
                               "com/alibaba/tuna/fastjson/serializer/FilterUtils",
    ...
    private void _if_write_null(MethodVisitor mw, FieldInfo fieldInfo, Context context) {
        ...
        if (!writeNull) {
            mw.visitVarInsn(ALOAD, context.var("out"));
            mw.visitFieldInsn(GETSTATIC, "com/alibaba/tuna/fastjson/serializer/SerializerFeature", "WriteMapNullValue",
                              "Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;");
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "isEnabled",
                               "(Lcom/alibaba/tuna/fastjson/serializer/SerializerFeature;)Z");
            mw.visitJumpInsn(IFEQ, _else);
        ...
        if (propertyClass == String.class || propertyClass == Character.class) {
            if (writeNullStringAsEmpty) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldNullString",
            ...
            if (writeNullNumberAsZero) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldNullNumber",
                                   "(CLjava/lang/String;)V");
            }
        } else if (propertyClass == Boolean.class) {
            if (writeNullBooleanAsFalse) {
                ...
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldNullBoolean",
                                   "(CLjava/lang/String;)V");
            }
        } else if (Collection.class.isAssignableFrom(propertyClass) || propertyClass.isArray()) {
            if (writeNullListAsEmpty) {
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldEmptyList",
                                   "(CLjava/lang/String;)V");
            } else {
                mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldNullList",
                                   "(CLjava/lang/String;)V");
            }
        } else {
            mw.visitMethodInsn(INVOKEVIRTUAL, "com/alibaba/tuna/fastjson/serializer/SerializeWriter", "writeFieldNull",
                               "(CLjava/lang/String;)V");
        }
